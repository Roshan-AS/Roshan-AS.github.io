...
## Class Updates
All updates, Q&A, class schedule, Progamming Assignments, Homeworks, and Wireshark Labs are updated on <a href="https://piazza.com/buffalo/fall2023/cse489589">Piazza</a>. Please join at the following link: 
https://piazza.com/buffalo/fall2023/cse489589<br>
Access Code: You should find it under the <b>Announcements</b> tab in UBLearns Brightspace.
...
**Teaching Assistants:**
**Liyao Li**\
Office Hours: Mon 2:00-4:00 PM on Zoom\
Email: liyaoli [at] buffalo.edu


**Graders:**\
**Kushan Deverajagowda**\
Office Hours: F 3:00-5:00 PM on Zoom\
Email: kushande [at] buffalo.edu\
**Subhojeet Roy**\
Office Hours: Tue 3:00-5:00 PM on Zoom\
Email: ssubhojee [at] buffalo.edu

## Time and Location
 - Lectures: M/W, 5:00-6:20 PM, Cooke 121
...
At the end of this course, each student should be able to:
 ...
 - Know how to use popular networking tools such as <a href="http://www.wireshark.org/" target ="_blank">WireShark</a> and <a href="http://iperf.sourceforge.net/" target ="_blank">iperf</a>.
 - Start reading more advanced/research-oriented networking materials.

------------------
 
## Pre-requisites
Students need to have some basic knowledge of operating systems, calculus and probability theory, data structures, and algorithms. In addition, they **must be proficient in C or C++ programming**.
 
---------------
 
## Required Textbook
  
 <table class=MsoNormalTable border=0 cellpadding=0 style='width:6.76in;

 mso-cellspacing:1.5pt;mso-padding-alt:0in 5.4pt 0in 5.4pt'> 
 <tr style='mso-yfti-irow:0;mso-yfti-lastrow:yes'> 
  <td style='padding:.75pt .75pt .75pt .75pt' class="auto-style1"> 
  <p><span><font size="4"><a href="http://www-net.cs.umass.edu/personnel/kurose.html" target="_top">James
  F. F. Kurose</a> and <a href="http://cis.poly.edu/%7Eross/" target="_top">Keith
  W. Ross</a>, &quot;<b><i>Computer Networking: A Top-Down Approach Featuring
  the Internet</i></b>&quot;, 7th edition, Addison Wesley, 2017.</font></span></p> 
  </td> 
  <td width=231 style='width:98.25pt;padding:.75pt .75pt .75pt .75pt'> 
  <p class=MsoNormal> <img width=100 height=131 
  src="cover_7th.jpg" align=right v:shapes="_x0000_s1026"><span 
...
### Reference Textbooks
 ...
 - *UNIX Network Programming : Networking APIs : Sockets and XTI : Volume 1, Second Edition*, W. Richard Stevens, Prentice Hall, Oct 1997, ISBN: 013490012X. <span style="color:red">**Recommended!**</span>
...
Each student must correctly answer all the questions in the AI Quiz before Fall Break (Oct. 9), in order to receive any final grade other than F. Each student will have an unlimited number of tries before the above stated deadline.

Assuming that the student answers all the questions in the AI Quiz correctly, then the overall score will be calculated based on the scores from the Homework, Lab, Exam and Programming Assignments as follows:
- Midterm Exam: 20%
- Final Exam: 20%
...
- 2 Programming Assignments (C or C++ programming): 40% (PA1 30% with two stages + PA2 10%)
...
- **Complete the AI Quiz** available on the UBLearns Brightspace platform under Admin. More information can be found [**HERE**](ttps://www.buffalo.edu/academic-integrity/resources/Academic-Integrity-at-UB.html).
...
- Wireshark labs: Labs need to be done **individually**. Discussions of ideas are welcome, but exchanges of reports are not allowed</li>
